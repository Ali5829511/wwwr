...
### Git Workflow - إدارة التغييرات

**أداة فحص التغييرات** - للتحقق من التغييرات غير المحفوظة قبل الإجراءات المهمة:

```bash
# فحص حالة Git
./check-changes.sh

# المتابعة بالقوة (force proceed)
./check-changes.sh --force
```

**📖 للمزيد من التفاصيل:** راجع [دليل Git Workflow](GIT_WORKFLOW.md) للحصول على:
- كيفية التعامل مع التغييرات غير المحفوظة
- متى يكون آمناً المتابعة
- أفضل ممارسات Git
- نصائح حل المشاكل
...
### الميزات التي تحتاج إلى بنية خلفية (Backend) 🔄
هذه الميزات موثقة وجاهزة للتطبيق عند توفر البنية الخلفية:
- [ ] دمج مع قاعدة بيانات خلفية (موثق في [CLOUD_DATABASE_SETUP.md](CLOUD_DATABASE_SETUP.md))
- [ ] بناء REST API (موثق في [DEVELOPER_GUIDE.md](docs/DEVELOPER_GUIDE.md))
- [ ] تشفير كلمات المرور (موثق في [SECURITY.md](SECURITY.md))
- [ ] سجلات الأنشطة (Audit Logs) (موثق في [SECURITY_SETUP.md](SECURITY_SETUP.md))
...
- **DEPLOYMENT_CHECKLIST.md**: 📋 قائمة تحقق نهائية شاملة قبل النشر ⭐ جديد
- **PRODUCTION_CHECKLIST.md**: قائمة تحقق من جاهزية النظام للإنتاج
- **SECURITY.md**: إرشادات الأمان والثغرات الحالية والحلول
- **SECURITY_SETUP.md**: 🔒 دليل إعداد الأمان خطوة بخطوة ⭐ جديد
- **OFFLINE_USAGE.md**: دليل الاستخدام بدون اتصال بالإنترنت
- **DEVELOPER_GUIDE.md**: دليل شامل للمطورين

### أدلة قاعدة البيانات والتخزين
- **CLOUD_DATABASE_SETUP.md**: 🗄️ دليل شامل لربط قاعدة بيانات سحابية (Firebase/Supabase) ⭐ جديد
- **IMAGE_UPLOAD_GUIDE.md**: 📸 دليل كامل لنظام رفع الصور الآمن ⭐ جديد
- **database_documentation.md**: توثيق قاعدة البيانات المحلية
...
├── README.md                # هذا الملف
├── GIT_WORKFLOW.md          # دليل سير عمل Git
├── check-changes.sh         # أداة فحص التغييرات
